        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
              O que você pode esperar da NaBagagem: criação de viagens customizadas com planejamento de roteiros, 
              escolha de hospedagens, passagens, atrações e experiências personalizadas, feitas sob medida para você.
            </p>
          ...
          <div className="mb-16">
            <Card className="overflow-hidden shadow-elegant">
              <CardContent className="p-0">
                <img 
                  src={travelExperiences}
                  alt="Experiências de viagem personalizadas"
